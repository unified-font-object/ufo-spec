...
The kerning pair members are glyph names or group names. Group names used as the first member of a kerning pair must begin with the _firstKerningGroupPrefix_. Group names used as the second member of a kerning pair must begin with _secondKerningGroupPrefix_. These prefixes are defined in "fontinfo.plist":fontinfo.html#kerning-group-prefixes. Glyphs or groups in the pairs are not required to be in the font.
