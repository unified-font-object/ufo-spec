...
Kerning pair members may be group names. This allows the kerning data to represent vast numbers of kerning pairs will relatively few kerning pairs. A pair member that is a group name implies that all members of the group are kerned with the other member of the pair with the same value unless an exception is defined. For example, a group with the name _&#64;KERN_1_O_ has _O_, _D_ and _Q_ as members. The kerning pair _&#64;KERN_1_0 + A_ has a value of -20. This implies that _O + A_, _D + A_ and _Q + A_ all have the value -20.

structures
  maybe explain it in terms of levels
  explain what a group as a pair member means
...
types
  basic
  exception
    glyph, glyph exception to:
      group, group
      group, glyph
      glyph, group
    group, glyph exception to:
      group, group
    glyph, group exception to:
      group, group
    can't make glyph, group and exception to group, glyph or vice versa

explain resolution order

@O_L: O D Q
@H_R: H B D E F H I K L M N P R
