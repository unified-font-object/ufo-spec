...
The value of per layer guides is under debate. The most common model currently in use (FontLab, others) allows for font level guides and glyph level guides. There are no per layer guides available. An alternative proposal is to add place for font level guides in fontinfo.plist.
</div>
