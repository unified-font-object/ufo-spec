...
| versionMajor        | positive integer | Major version. |
...
|_. key           |_. value type     |_. description |
| unitsPerEm      | positive integer or float | Units per em. |
...
| openTypeHeadLowestRecPPEM | positive integer or float | Smallest readable size in pixels. Corresponds to the OpenType head table lowestRecPPEM field. |
...
|_. key      |_. value type     |_. description |
| nameID     | positive integer | The name ID. |
| platformID | positive integer | The platform ID. |
| encodingID | positive integer | The encoding ID. |
| languageID | positive integer | The language ID. |
...
| openTypeOS2Panose             | number list      | The list must contain 10 positive integers that represent the setting for each category in the Panose specification. The integers correspond with the option numbers in each of the Panose categories. This corresponds to the OpenType OS/2 table Panose field. |
...
| openTypeOS2WinAscent          | positive integer or float | Ascender value. Corresponds to the OpenType OS/2 table usWinAscent field. |
| openTypeOS2WinDescent         | positive integer or float | Descender value. Corresponds to the OpenType OS/2 table usWinDescent field. |
...
|_. key                      |_. value type     |_. description |
| woffMajorVersion           | positive integer | Major version of the font. |
| woffMinorVersion           | positive integer | Minor version of the font. |
...
Need to finalize extension elements.
...
h5. Metadata Extension Records

This is a very complex thing to represent. These are the ideas so far.
    ...
    # extension record
    {
        ...
        items : [
            # item record
            {
                ...
                # names
                names : [
                    {name : string, lang : string or None}
                ]
                # values
                values : [
                    {name : string, lang : string or None}
