...
The terms "must", "must not", "required", "shall", "shall not", "should", "should not", "recommended", "may", and "optional" conform to "RFC 2119":http://www.ietf.org/rfc/rfc2119.txt.
...
# A tool that allows for import data from or exporting data to a UFO.
* A user specific script for modifying a UFO.
