...
| directory        | string      | The directory the image is stored in. If this is not given, the image must be stored in the _images_ directory within the UFO. | None |
...
### The names must begin with the appropriate prefix as defined by leftKerningGroupPrefix and rightKerningGroupPrefix in fontinfo.plist.
