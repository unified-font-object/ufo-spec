...
The name _public.*_, where _*_ represents an arbitrary string of one or more characters, is reserved for use by data structures that are part of the UFO specification.
