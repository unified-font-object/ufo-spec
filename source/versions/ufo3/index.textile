...
| "layercontents.plist":glyphs.html                     | Glyphs directory name to layer name mapping. |
...
Changed the special considerations for kerning groups to reflect the new prefixes.
...
A new linkref element was added.
